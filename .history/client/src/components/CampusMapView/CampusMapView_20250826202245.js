...
const CampusMapView = () => {
    ...
    },
    {
      ...
      floors: [
        ...
        { 
          ...
          sensors: [
            { id: 331, name: 'מעבדת רובוטיקה', x: 25, y: 35, occupied: true, count: 9, maxCapacity: 20 },
            { id: 332, name: 'מעבדת בקרה', x: 75, y: 35, occupied: false, count: 0, maxCapacity: 15 },
            { id: 333, name: 'חדר סמינרים', x: 50, y: 75, occupied: true, count: 12, maxCapacity: 20 }
          ]
        }
      ]
    }
  ...
  const handleBuildingClick = (building) => {
    ...
    setSelectedFloor(building.floors[0]); // Select first floor by default
  };
