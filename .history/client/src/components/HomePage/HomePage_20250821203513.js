    ...
    <div className="home-page">
      ...
      <main className="hero-section">
        <div className="hero-background">
          ...
          {/* תמונה אופציונלית - אם אין אותה זה לא יקרוס */}
          <div className="campus-bg-placeholder"></div>
        </div>
        ...
        <div className="hero-content">
          <div className="hero-text">
            ...
            <p className="hero-description">
              מערכת ניהול חכמה לקמפוס הטכנולוגי חולון. 
        ...
        <div className="floating-elements">
          <div className="floating-stat">
            ...
            <span className="floating-text">נתונים בזמן אמת</span>
          </div>
          ...
          <div className="floating-stat">
            <span className="floating-icon">🎓</span>
            <span className="floating-text">15,000+ סטודנטים</span>
          </div>
        </div>
