  ...
  return (
    <Router>
      <div className="App">
        ...
        <Route path="/monitoring" element={<div style={{color: 'white', padding: '2rem'}}>Admin Panel</div>} />
        <Route path="/reports" element={<div style={{color: 'white', padding: '2rem'}}>Contact us</div>} />
        <Route path="/alerts" element={<div style={{color: 'white', padding: '2rem'}}>Notifications</div>} />
